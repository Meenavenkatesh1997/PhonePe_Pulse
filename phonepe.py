...
if select == "Home":
    ...
    with col1:
        ...
        st.markdown("PhonePe is an Indian digital payments and financial services company based out of Bangalore, India. It was founded in 2015, by Sameer Nigam, Rahul Chari, and Burzin Engineer. The PhonePe app, based on the Unified Payments Interface, went live in August 2016")
        st.write("****FEATURES****")
    ...
    with col2:
        st.video("C:\\Users\\Meenakshi\\OneDrive\\Desktop\\Phonepe_\\Phone Pe Ad.mp4")

    col3,col4= st.columns(2)
    
    with col3:
        st.image(Image.open(r"C:\Users\Meenakshi\OneDrive\Desktop\Phonepe_\download (3).jpeg"))

    with col4:
        st.subheader("USES OF PHONEPE")
        st.write("****Make online purchases****")
        st.write("****Send and receive money****")
        st.write("****Pay bills****")
        st.write("****Get Cashbacks****")
        st.write("****Invest in tax-saving funds****")
        st.write("****Multiple Payment Modes****")
        st.write("****Make Insurance payments****")
        st.write("****Bid on initial public offerings****")
    ...
    with col5:
        ...
        st.markdown(" ")
        st.markdown(" ")
        st.subheader("****Multiple Ways To Pay****")
    ...
    with col6:
        st.image(Image.open(r"C:\Users\Meenakshi\OneDrive\Desktop\Phonepe_\Phonepe.image.jpg"))
